...
<body class="bg-white dark:bg-gray-900">
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        <aside id="sidebar" class="fixed top-1 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
            <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-t border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Tables</span>
                            ...
                            <x-sidebar-link :href="route('article.report')" :active="request()->routeIs('article.report')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6  group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"">
                                    <path stroke-linecap=" round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 16.5v.75m3-3v3M15 12v5.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                                </svg>
                                <span class="ml-3" sidebar-toggle-item>Article Report</span>
                            </x-sidebar-link>
                        </ul>
                        </li>
                        </ul>
